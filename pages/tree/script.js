...
FamilyTree.templates.myTemplateRoot = Object.assign({}, FamilyTree.templates.myTemplate);
FamilyTree.templates.myTemplateRoot.node = '<rect x="0" y="0" width="140" height="180"  fill="#044B94" fill-opacity="0" stroke="none"></rect>' +
    '<circle cx="70" cy="60" r="60" fill="#4D4D4D"></circle>' +
    '<circle cx="70" cy="60" fill="#ffffff" r="40"></circle>' +
    '<circle stroke="#D7DBDD" stroke-width="3" fill="#D7DBDD" cx="70" cy="40" r="13"></circle>' +
    '<path d="M40,83 C40,49 100,49 100,83" stroke="#D7DBDD" stroke-width="3" fill="#D7DBDD"></path>';

FamilyTree.templates.myTemplateOrange = Object.assign({}, FamilyTree.templates.myTemplate);
FamilyTree.templates.myTemplateOrange.node = '<rect x="0" y="0" width="140" height="180"  fill="#044B94" fill-opacity="0" stroke="none"></rect>' +
...
FamilyTree.templates.myTemplateOrange.ripple = {
    radius: 60,
    color: "#4D4D4D",
    rect: { x: 10, y: 0, width: 120, height: 120 }
};

FamilyTree.templates.myTemplateBrown = Object.assign({}, FamilyTree.templates.myTemplate);
FamilyTree.templates.myTemplateBrown.node = '<rect x="0" y="0" width="140" height="180"  fill="#044B94" fill-opacity="0" stroke="none"></rect>' +
...
FamilyTree.templates.myTemplateBrown.ripple = {
    radius: 60,
    color: "#ED9422",
    rect: { x: 10, y: 0, width: 120, height: 120 }
};
...
family.load(
    [
        ...
        { id: 3, pids: [1, 2], gender: 'female', photo: 'https://cdn.balkan.app/shared/w60/1.jpg', name: 'Laura Shepherd', born: '1943-01-13', email: 'laura.shepherd@gmail.com', phone: '+44 845 5752 547', city: 'Moscow', country: 'ru', tags: ['root'] },
        { id: 4, pids: [5], photo: 'https://cdn.balkan.app/shared/m60/3.jpg', name: 'Rowan Annable', tags: ['orange'] },
        { id: 5, pids: [4], gender: 'female', photo: 'https://cdn.balkan.app/shared/w60/3.jpg', name: 'Lois Sowle', tags: ['orange'] },
        { id: 6, mid: 2, fid: 3, pids: [7], gender: 'female', photo: 'https://cdn.balkan.app/shared/w30/1.jpg', name: 'Tyler Heath', born: '1975-11-12', tags: ['orange'] },
        { id: 7, pids: [6], mid: 5, fid: 4, gender: 'male', photo: 'https://cdn.balkan.app/shared/m30/3.jpg', name: 'Samson Stokes', born: '1986-10-01', tags: ['brown'] },
        { id: 8, mid: 7, fid: 6, gender: 'female', photo: 'https://cdn.balkan.app/shared/w10/3.jpg', name: 'Celeste Castillo', born: '2021-02-01', tags: ['brown'] }
    ]
);